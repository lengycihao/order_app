...
//                   _updateStickyCategory(notification.metrics.pixels);
//                 }
//                 return false;
//               },
...
//     print('🔧 构建Sliver列表，分类数量: ${controller.categories.length}');
...
//   /// 更新吸顶分类状态
//   void _updateStickyCategory(double scrollOffset) {
//     if (_categoryPositions.isEmpty) return;
    
//     int newStickyCategory = 0;
//     for (int i = _categoryPositions.length - 1; i >= 0; i--) {
//       if (scrollOffset >= _categoryPositions[i]) {
//         newStickyCategory = i;
//         break;
...
//     if (newStickyCategory != _currentStickyCategory) {
//       setState(() {
//         _currentStickyCategory = newStickyCategory;
//       });
//       // 调试信息
//       print('🔄 吸顶分类更新: ${controller.categories[newStickyCategory]} (索引: $newStickyCategory)');
//     }
//   }
