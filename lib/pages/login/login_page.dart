...
import 'package:order_app/pages/login/server_config/server_config_page.dart';
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Obx(
                            () => SizedBox(
                              ...
                              child: TextField(
                                ...
                                keyboardType:
                                    TextInputType.emailAddress, // 邮箱键盘布局
                                inputFormatters: [
                                  FilteringTextInputFormatter.allow(
                                    RegExp(r'[a-zA-Z0-9@._-]'),
                                  ), // 只允许英文数字和常用符号
                                ...
                                decoration: InputDecoration(
                                  ...
                                  suffixIcon: IconButton(
                                    ...
                                    onPressed:
                                        controller.showPasswordTemporarily,
                                  ),
                                  contentPadding: EdgeInsets.symmetric(
                                    vertical: 0,
                                    horizontal: 16,
                          ...
                          Obx(
                            () => GestureDetector(
                              onTap: controller.isLoggingIn.value
                                  ? null
                                  : controller.login,
                              child: Container(
                                width: context.adaptWidth(253),
                            ...
                            decoration: BoxDecoration(
                              border: Border(
                                bottom: BorderSide(
                                  ...
                                  width:
                                      controller.recentAccounts.last == account
                                      ? 0
                                      : 0.5,
                                ),
                              ),
              ...
              child: GestureDetector(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(width: 8),
                    Image(
                      image: AssetImage('assets/server_right.webp'),
                      width: 16,
                      height: 16,
                    ),
                  ],
